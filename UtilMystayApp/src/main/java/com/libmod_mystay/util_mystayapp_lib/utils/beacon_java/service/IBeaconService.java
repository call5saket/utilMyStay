 ...
 * under the License.
 */
package com.libmod_mystay.util_mystayapp_lib.utils.beacon_java.service;
        ...
        public void handleMessage(Message msg)
        {
             ...
             if (service != null) {
                 ...
                 case MSG_START_RANGING:
                 	...
                 	service.startRangingBeaconsInRegion(startRMData.getRegionData(), new com.libmod_mystay.util_mystayapp_lib.utils.beacon_java.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                    break;
                 ...
                 case MSG_START_MONITORING:
                 	...
                 	service.startMonitoringBeaconsInRegion(startRMData.getRegionData(), new com.libmod_mystay.util_mystayapp_lib.utils.beacon_java.service.Callback(msg.replyTo, startRMData.getIntentActionForCallback()));
                 	break;
